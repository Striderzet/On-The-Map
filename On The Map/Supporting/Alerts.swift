...
extension UIViewController {
    ...
    func logoutQuestion(){
        ...
        let alert = UIAlertController(title: "LOGGING OUT", message: "Are you sure you want to logout of the application?", preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "YES", style: .default, handler: { action in
            
            //logout function should go here
            
            udacityConvenience.authenticateLogout{ (type, sucess) in
